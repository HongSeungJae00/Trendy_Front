...
import { ProductRegistrationForm } from "@/components/admin-product-registration-form";
...
export default function ProductRegistrationPage() {
  ...
  const handleRegister = async (productData: ProductForm) => {
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6 bg-gray-50 flex flex-col">
          <div className="flex-grow">
            <h1 className="text-lg font-bold mb-6">상품 등록</h1>
            <ProductRegistrationForm 
              onRegister={(productData) => handleRegister(productData)} 
            />
          </div>
